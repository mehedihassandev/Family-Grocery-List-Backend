...
class DeviceTokenRequest(BaseModel):
    ...
    device_type: str | None = Field("android", description="Device platform e.g. android, ios, web")
    app_version: str | None = Field(None, description="App version e.g. 1.0.0")
...
class NotificationItem(BaseModel):
    ...
    type: str = Field(
        ...,
        description="Event type e.g. ITEM_ADDED, ITEM_COMPLETED, ITEM_UPDATED, MEMBER_JOINED",
    )
